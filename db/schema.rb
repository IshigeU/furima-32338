...
ActiveRecord::Schema.define(version: 2021_02_20_023526) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "delivary_cost_id", null: false
    t.integer "prefecture_id", null: false
    t.integer "delivary_day_id", null: false
    t.integer "items_category_id", null: false
  ...
  create_table "orderer_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_history_id"], name: "index_orderer_infos_on_purchase_history_id"
  end
  ...
  add_foreign_key "orderer_infos", "purchase_histories"
